...
namespace Data.Auth.Repositories
{
    ...
    {
        public async Task<Core.Auth.Models.User> GetUserByUsernameAndPasswordAsync(string username, string password)
        {
            ...
            return new Core.Auth.Models.User
            {
        ...
        public async Task<Core.Auth.Models.User> GetUserByUniqueIdAsync(Guid uniqueId)
        {
            var user = await context.Users
                    .AsNoTracking()
                    .Where(u => u.UniqueId == uniqueId)
                    .Select(u => new Core.Auth.Models.User
                    {
